                    ...
                    <?php foreach ($siswa as $d) :  ?>
                        ...
                        <tr>
                            ...
                            if (isset($_GET['bulan']) && isset($_GET['kelas'])) {
                                ...
                                $kelas = $_GET['kelas'];
                                $jurusann = $_GET['jurusan'];
                                $sql = "SELECT * FROM tb_detail_absen WHERE nis = '$nis' AND kode_kelas = '$kelas' AND kode_jurusan = '$jurusann' AND tanggal_absen LIKE '%$tahun-$bulan%' ORDER BY tanggal_absen ASC";
                            } else {
                                $sql = "SELECT * FROM tb_detail_absen WHERE nis = '$nis' AND  kode_kelas = '$kelass' AND kode_jurusan = '$jurusann' AND tanggal_absen LIKE '%$tahun-$cari_bulan_siswa%' ORDER BY tanggal_absen ASC";
                                $bulan = date('m');
                            }
