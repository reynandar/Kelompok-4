			...
			<div class="row">
				<div class="col-xl-12 col-xxl-12">
					...
					if (count($cekliburweekend) > 0 && $cekliburweekend[0]['status'] == 'Aktif') {
						...
						$tgl = date('Y-m-d');
						$keterangan = $this->db->query("SELECT * FROM tb_libur WHERE tanggal = '$tgl' ")->result_array()[0];
								...
								<div class="card-body">
									<table class="table table-responsive-md">
										...
										<tbody>
											...
											$tgl = date('Y-m-d');
											$nis = $user['nis'];
											$masuk = $this->db->query("SELECT * FROM tb_detail_absen WHERE nis = '$nis' AND tanggal_absen = '$tgl' AND masuk = '1' ")->num_rows();
											$keluar = $this->db->query("SELECT * FROM tb_detail_absen WHERE nis = '$nis' AND tanggal_absen = '$tgl' AND keluar = '1' ")->num_rows();
											?>
									...
									<div class="card-body  p-4">
										<div class="media">
											...
											<div class="media-body text-white">
												...
												<p>Izin : <?= $this->db->query("SELECT * FROM tb_detail_absen WHERE nis = '$nis' AND tanggal_absen = '$tgl' AND keterangan = 'i' ")->num_rows()  ?> Sakit : <?= $this->db->query("SELECT * FROM tb_detail_absen WHERE nis = '$nis' AND tanggal_absen = '$tgl' AND keterangan = 's' ")->num_rows()  ?> Alpha : <?= $this->db->query("SELECT * FROM tb_detail_absen WHERE nis = '$nis' AND tanggal_absen = '$tgl' AND keterangan = 'a' ")->num_rows()  ?></p>
									...
									<div class="card-body  p-4">
										<div class="media">
											...
											<div class="media-body text-white">
												...
												<p>Jumlah : <?= $this->db->query("SELECT * FROM tb_libur WHERE tanggal LIKE '%$bulanini%' AND status = 'Aktif' ")->num_rows() ?></p>
									...
									<div class="card-body  p-4">
										<div class="media">
											...
											<div class="media-body text-white">
												...
												<?php
												$nis = $user['nis_siswa'];
												$sqlcekizin = "SELECT * FROM tb_izin WHERE nis_siswa = '$nis'";
