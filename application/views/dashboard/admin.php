				...
				<div class="col-xl-9 ">
					<div class="card border-0 pb-0">
						<div class="card-header border-0 pb-0">
							...
							$querycekizin = "SELECT * FROM tb_izin JOIN tb_siswa on tb_siswa.nis = tb_izin.nis_siswa WHERE tanggal_izin LIKE '%$thbulan%' ORDER BY tanggal_izin DESC LIMIT 10";
								...
								<div class="card-body  p-4">
									<div class="media">
										...
										<div class="media-body text-white">
											...
											<h3 class="text-white"><?= $this->db->query("SELECT * FROM tb_siswa")->num_rows() ?></h3>
								...
								<div class="card-body p-4">
									<div class="media">
										...
										<div class="media-body text-white">
											...
											<?php
											$akunpetugas = $this->db->query("SELECT * FROM tb_user")->num_rows();
								...
								<div class="card-body p-4">
									<div class="media">
										...
										<div class="media-body text-white">
											...
											<h3 class="text-white"><?= $this->db->query("SELECT * FROM tb_kelas")->num_rows() ?></h3>
											<div class="progress mb-2 bg-primary">
