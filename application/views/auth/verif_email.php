            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form>
                            <input class="form-control email" type="text" name="email" placeholder="contoh@contoh.com" required>
                            <div class="info"></div>
...
<script>
    ...
    $('#submit').click(function(e) {
        ...
        if (validateEmail(email) == false) {
            $('.info').html('<small class="error-message ">Harap Masukan Email Yang Valid !</small>');
        } else {
            $(this).html('Memproses..');
            $.ajax({
                type: 'POST',
                url: "<?php echo base_url(); ?>ajax/verif_email_staff",
                data: {
                    email: email,
                },
                dataType: 'json',
