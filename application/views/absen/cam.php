            ...
            <div class="col-lg-8 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body " id="bodybody">
                        ...
                        <?php
                        $sqlmasuk = "SELECT * FROM tb_jam_absen WHERE type = 'Masuk' ";
                        $sqlkeluar = "SELECT * FROM tb_jam_absen WHERE type = 'Keluar' ";
                        $sqlterlambat = "SELECT * FROM tb_jam_absen WHERE type = 'Terlambat' ";
    ...
    <script type="text/javascript">
        ...
        if (now >= jammasuk && now < akhirmasuk) {
            ...
            var x = setInterval(function() {
                ...
                $('.infoHP').html(`<h1>Silahkan absen masuk</h1>`)
            ...
            var x = setInterval(function() {
                ...
                $('.infoHP').html(`<h1>Absen berakhir</h1>`)
                $('#view').hide()
            ...
            var x = setInterval(function() {
                ...
                $('.infoHP').html(`<h1>Silahkan Absen Keluar</h1>`)
                // document.getElementById("bodybody").innerHTML = days + " Hari " + hours + " Jam " +
                //     minutes + " Menit " + seconds + " Detik ";
                if (distance < 0) {
                    clearInterval(x);
